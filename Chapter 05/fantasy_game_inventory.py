#! /usr/bin/python
#
# ATBS2E - Chapter 5 - Fantasy Game Inventory
#
...
# that item the player has. For example, the dictionary value {'rope': 1, 'torch':
# 6, 'gold coin': 42, 'dagger': 1, 'arrow': 12} means the player has 1 rope, 6
