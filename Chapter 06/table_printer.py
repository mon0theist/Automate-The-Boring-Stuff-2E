#! /usr/bin/python
#
# ATBS2E - Chapter 6 - Table Printer
#
...
# tableData[0], colWidths[1] can store the width of the longest string in tableData[1],
# and so on. You can then find the largest value in the colWidths list to find
# out what integer width to pass to the rjust() string method.
...
def printTable(table):
    ...
    while count < len(table):
        for item in table[count]:
            ...
            # not sure what the intended method was
        count += 1
